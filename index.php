        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    <h1 class="mb-0">
                        Ashutosh
                        <span class="text-primary">Koli</span>
                    </h1>
...
Registers, Instruction Registers, Instruction Counter and Toggle after execution of each instruction.</li>
            ...
            <section class="resume-section" id="education">
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            <h3 class="mb-0">Vishwakarma Institute of Technology, Pune</h3>
                            <div class="subheading mb-3">Bachelor of Technology</div>
                            <div>Computer Engineering</div>
                            <p>CGPA: 9.39</p>
                        </div>
                        <div class="flex-shrink-0"><span class="text-primary">August 2020 - May 2023</span></div>
                    </div>
            ...
            <section class="resume-section" id="skills">
                <div class="resume-section-content">
                    ...
                    <div class="subheading mb-3">Programming Languages & Skills</div>
                    <ul class="fa-ul mb-0">
                        <li>
                ...
                <div class="resume-section-content">
                    ...
                    <ul class="fa-ul mb-0">
                        <li>
                            ...
                            TechnoWings International IT Solutions Inplant Training Certification
                        </li>
                        <li>
                            <span class="fa-li"><i class="fas fa-trophy text-warning"></i></span>
                            Microsoft MTA: Database Fundamentals - Microsoft Certification
                        </li>
                        <li>
                            <span class="fa-li"><i class="fas fa-trophy text-warning"></i></span>
                            1
                            <sup>st</sup>
                            Place - SVERI's College of Engineering, Pandharpur - Paper Presentation Competition 2020
                        </li>
                        <li>
                            <span class="fa-li"><i class="fas fa-trophy text-warning"></i></span>
                            1
                            <sup>st</sup>
                            Place - SVERI's College of Engineering, Pandharpur - Java Programming Competition 2020
                        </li>
                        <li>
                            <span class="fa-li"><i class="fas fa-trophy text-warning"></i></span>
                            2
                            <sup>nd</sup>
                            Place - Solapur Youth Festival - Project Competition 2020
                        </li>
                        <li>
                            <span class="fa-li"><i class="fas fa-trophy text-warning"></i></span>
                            2
                            <sup>nd</sup>
                            Place - Solapur Zonals - Carrom Competition (2019-2020)
                        </li>
